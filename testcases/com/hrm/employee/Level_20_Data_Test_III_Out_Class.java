...
public class Level_20_Data_Test_III_Out_Class extends BaseTest {
	WebDriver driver;
	String statusValue, employeeID;
	String avatarFilePath = GlobalConstants.UPLOAD_FOLDER_PATH + "Avatar.jpg";
	String  editEmpGender, editEmpMaritalStatus, editEmpNational;
	...
	public void Employee_01_Add_New_Employee() {
		...
		addEmployeePage.enterToTextboxByIDHRM(driver, "firstName", Employee.PersonalDetail.FIRSTNAME);

		log.info("Add_New_01 - Step 04: Enter valid info to 'Last Name' textbox");
		addEmployeePage.enterToTextboxByIDHRM(driver, "lastName", Employee.PersonalDetail.LASTNAME);
		...
		addEmployeePage.enterToTextboxByIDHRM(driver, "user_name", Employee.PersonalDetail.USERNAME);
		...
		employeeListPage.enterToTextboxByIDHRM(driver, "empsearch_employee_name_empName", Employee.PersonalDetail.FULLNAME);
		verifyTrue(employeeListPage.isJQueryAndAjaxLoadedSuccess(driver));
		...
		verifyEquals(employeeListPage.getValueInTableAtRowIndexAndColumnName(driver, "resultTable", "First (& Middle) Name", "1"), Employee.PersonalDetail.FIRSTNAME);

		verifyEquals(employeeListPage.getValueInTableAtRowIndexAndColumnName(driver, "resultTable", "Last Name", "1"),  Employee.PersonalDetail.LASTNAME);
	}
	...
	public void Employee_03_Edit_Personal_Details() {
		...
		myInfoPage.enterToTextboxByIDHRM(driver, "personal_txtEmpFirstName", Employee.ContactDetail.FIRSTNAME);

		log.info("Personal_Detail_03 - Step 10: Enter new value to Last Name textbox");
		myInfoPage.enterToTextboxByIDHRM(driver, "personal_txtEmpLastName", Employee.ContactDetail.LASTNAME);
		...
		verifyEquals(myInfoPage.getTextboxValueByIDHRM(driver, "personal_txtEmpFirstName"), Employee.ContactDetail.FIRSTNAME);

		log.info("Personal_Detail_03 - Step 17: Verify 'Last Name' textbox is updated successfully");
		verifyEquals(myInfoPage.getTextboxValueByIDHRM(driver, "personal_txtEmpLastName"), Employee.ContactDetail.LASTNAME);
